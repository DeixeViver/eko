...
Mas nesse momento vamos focar só na nossa querida Internet e como tudo que vamos discutir no decorrer das Trilhas deixará esse contexto de caixa preta mais transparente e útil para nós.
...
Muitas vezes eles precisam de dados de entrada, no caso, para fazer login em redes como Twitter, Instagram e Facebook você precisa informar o seu nome de usuário e a sua senha, para que o algoritmo de autenticação seja capaz de verificar na base de dados da rede social se existe um usuário com aquele nome e se a senha informada corresponde com a verdadeira senha cadastrada pela dona ou dono daquela conta. A partir do momento que você entra na rede social tudo aquilo que você faz é vinculado a sua conta. As curtidas, os stories, as fotos postadas, os comentários… tudo.
...
Tomando o Facebook como exemplo, você pode ver nesse link o que a política da plataforma fala sobre como usa os seus dados.
...
<iframe width="525" height="394" src="https://www.youtube.com/embed/3PzphtZC0hU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

Esse é um vídeo que exemplifica bem os problemas e desafios relacionados ao DO na Internet. Faz parte do Movimento Contra o Discurso de Ódio desenvolvido pelo Sector de Juventude do Conselho da Europa. 
...
Você pode ver alguns indicadores [aqui](http://indicadores.safernet.org.br/indicadores.html)
